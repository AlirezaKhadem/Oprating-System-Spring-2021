...
!   _temp_23 = &bm
	add	r14,-164,r1
	store	r1,[r14+-144]
!   Prepare Argument: offset=12  value=42  sizeInBytes=4
	mov	42,r1
	store	r1,[r15+4]
!   Send message Init
	load	[r14+-144],r1
...
!   _temp_32 = _temp_31 + 4
	...
	add	r1,4,r1
	store	r1,[r14+-124]
!   Data Move: _temp_30 = *_temp_32  (sizeInBytes=4)
	load	[r14+-124],r1
	load	[r1],r1
	store	r1,[r14+-132]
...
! VARIABLE INITIALIZATION...
! numWords
!   _temp_111 = numberOfBits div 32		(int)
	load	[r14+12],r1
	mov	32,r2
	cmp	r2,0
...
! IF STATEMENT...
	...
	mov	"\0\0IF",r10
!   if numberOfBits > 0 then goto _Label_113		(int)
	load	[r14+12],r1
	mov	0,r2
	cmp	r1,r2
	bvs	_runtimeErrorOverflow
...
!   _temp_115 = _temp_115 + numWords		(int)
	load	[r14+-24],r1
	load	[r14+-36],r2
	add	r1,r2,r1
	bvs	_runtimeErrorOverflow
...
!   _temp_116 = _temp_116 + 4
	...
	bvs	_runtimeErrorOverflow
	store	r1,[r14+-20]
!   arrayOfWords = alloc (_temp_116)
	load	[r14+-20],r1
	call	_heapAlloc
	load	[r14+8],r2
	store	r1,[r2+8]
!   Data Move: _temp_117 = arrayOfWords  (sizeInBytes=4)
	load	[r14+8],r1
	load	[r1+8],r1
	store	r1,[r14+-16]
!   Data Move: *_temp_117 = _temp_115  (sizeInBytes=4)
	load	[r14+-24],r1
	load	[r14+-16],r2
	store	r1,[r2]
!   _temp_117 = _temp_117 + 4
	load	[r14+-16],r1
	add	r1,4,r1
	store	r1,[r14+-16]
!   Initialize many entries in a loop...
!   Data Move: _temp_118 = numWords  (sizeInBytes=4)
	load	[r14+-36],r1
	store	r1,[r14+-12]
!   if _temp_118 <= 0 then goto _runtimeErrorArrayCountNotPositive
	load	[r14+-12],r1
	cmp	r1,r0
	ble	_runtimeErrorArrayCountNotPositive
_Label_119:
!   Data Move: *_temp_117 = 0  (sizeInBytes=4)
	mov	0,r1
	load	[r14+-16],r2
	store	r1,[r2]
!   _temp_117 = _temp_117 + 4
	...
	add	r1,4,r1
	store	r1,[r14+-16]
!   _temp_118 = _temp_118 + -1
	load	[r14+-12],r1
	add	r1,-1,r1
	store	r1,[r14+-12]
!   if intNotZero (_temp_118) then goto _Label_119
	load	[r14+-12],r1
	cmp	r1,r0
	bne	_Label_119
! RETURN STATEMENT...
